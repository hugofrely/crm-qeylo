...
const MERGE_FIELDS: { key: string; label: string }[] = [
  ...
  { key: "secondary_email", label: "Email secondaire" },
  { key: "phone", label: "Téléphone" },
  { key: "mobile_phone", label: "Mobile" },
  { key: "secondary_phone", label: "Tél. secondaire" },
  ...
  { key: "lead_score", label: "Score lead" },
  { key: "decision_role", label: "Rôle décisionnel" },
  { key: "preferred_channel", label: "Canal préféré" },
        ...
        <DialogHeader>
          ...
          <DialogTitle className="flex items-center gap-2">
            {view === "list" ? (
              <>
                ...
                Contact(s) similaire(s) trouvé(s)
              </>
            ) : (
              <>
          ...
          {view === "list" && (
            <p className="text-sm text-muted-foreground">
              {duplicates.length} contact(s) similaire(s) détecté(s) dans votre
              base
            </p>
          )}
        </DialogHeader>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="min-w-0 flex-1 space-y-1">
                      <div className="flex items-center gap-2">
                        ...
                        {duplicate.score >= 0.8 ? (
                          <Badge variant="destructive">Très probable</Badge>
                        ) : duplicate.score >= 0.5 ? (
              ...
              <div className="divide-y divide-border/60">
                ...
                {differingFields.length === 0 && (
                  <div className="px-4 py-6 text-center text-sm text-muted-foreground">
                    Aucune différence détectée entre les deux contacts.
                  </div>
                )}
              </div>
            </div>
