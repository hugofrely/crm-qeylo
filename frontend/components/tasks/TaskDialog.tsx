...
import type { Task, ContactSearchResult } from "@/types"
import { createTask, updateTask, deleteTask } from "@/services/tasks"
import { searchContacts as apiSearchContacts } from "@/services/contacts"
...
export function TaskDialog({
  ...
  const searchContacts = useCallback((query: string) => {
    ...
    debounceRef.current = setTimeout(async () => {
      ...
      try {
        const data = await apiSearchContacts(query)
